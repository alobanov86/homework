...
public class MergeTest {
    ...
    public void setUpTestData() {
        testData.put(new int[][]{{1, 5, 4, 23, 65, 32, 78}, {3, 5, 24, 4, 1, 2, 34, 45, 32, 5}}, new int[]{1,5,4,23,65,32,78,3,24,2,34,45});
        testData.put(new int[][]{null,{3, 5, 24, 4, 1, 2, 34, 45, 32, 5}}, new int[]{3, 5, 24, 4, 1, 2, 34, 45, 32});
        testData.put(new int[][]{{1, 5, 4, 23, 65, 32, 78},null}, new int[]{1, 5, 4, 23, 65, 32, 78});
        testData.put(new int[][]{{},{3, 5, 24, 4, 1, 2, 34, 45, 32, 5}}, new int[]{3, 5, 24, 4, 1, 2, 34, 45, 32});
    ...
    public void testMergeArrays() {
        for(Map.Entry<int[][], int[]> entry: testData.entrySet()){
            ...
            final int[] returnedValue = testClass.mergeArrays(firstArray, secondArray);
