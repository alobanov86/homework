...
public class InnerUnionTest {
    ...
    public void setUpTestData() {
        testData.put(new int[][]{{1, 5, 4, 23, 65, 32, 78}, {3, 5, 24, 4, 1, 2, 34, 45, 32, 5}}, new int[]{1, 5, 4, 32});
        testData.put(new int[][]{null,{3, 5, 24, 4, 1, 2, 34, 45, 32, 5}}, new int[]{});
        testData.put(new int[][]{{1, 5, 4, 23, 65, 32, 78},null}, new int[]{});
        testData.put(new int[][]{{},{3, 5, 24, 4, 1, 2, 34, 45, 32, 5}}, new int[]{});
        testData.put(new int[][]{{1, 5, 4, 23, 65, 32, 78},{}}, new int[]{});
    ...
    public void testInnerUnion() {
        for(Map.Entry<int[][], int[]> entry: testData.entrySet()){
            ...
            final int[] returnedValue = testClass.innerUnion(firstArray, secondArray);
